...
class faceNet():
    def __init__(self,img_width,img_height,num_classes=9):
    ...
    def build(self):
    	...
    	# 10x Bloque 17 (Inception-ResNet-B block):
    	...
    	# Mixed 7a (Reduccion-B block): 8 x 8 x 2080	
    	...
    	# 5x Bloque 8 (Inception-ResNet-C block):
    ...
    def run(self,x_train,y_train,x_test,y_test,batch_size=8,epochs=1,validation_split=0.1):
        ...
        print(f"Prueba de precision: {round(accuracy * 100, 2)}%")

        return history

    def save(self, filepath, overwrite=True, include_optimizer=True, save_format=None, signatures=None, options=None):
        # Puedes personalizar este método de acuerdo a tus necesidades
        # Este método es llamado cuando llamas a model.save() para guardar el modelo
        # Aquí puedes implementar la lógica para guardar los pesos y la arquitectura del modelo en un archivo
        # Por ejemplo, podrías guardar los pesos en un archivo .h5 y la arquitectura en un archivo .json
        # Asegúrate de llamar al método save_weights() y save_model() de forma apropiada para guardar los datos necesarios
        # Puedes consultar la documentación de Keras para obtener más información sobre cómo implementar este método: https://www.tensorflow.org/api_docs/python/tf/keras/models/Model#save
        pass