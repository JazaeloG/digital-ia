...
def vitNet():
    def __init__(self,image_size=128,batch_size=4,num_epochs=1):
        self.learning_rate = 0.001
        self.weight_decay = 0.0001
        self.batch_size = batch_size
        self.num_epochs = num_epochs
        self.image_size = image_size  # Redimensionar las imagenes a 128x128
        self.patch_size = 6  # Tamaño de los parches a extraer de la imagen
        ...
        self.transformer_units = [
            ...
            self.projection_dim,
        ]  # Tamaño del transformador de capas
        self.transformer_layers = 8
        self.mlp_head_units = [2048, 1024]  # Tamaño final de el clasificador final
